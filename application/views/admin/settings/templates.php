...
?>
<form action="<?= base_url('admin/settings/templates/' . $language . '/') ?><?= $setting_email ?>" method="post" class="bs-example form-horizontal">
    <section class="panel panel-custom">
        <header class="panel-heading  "> <?= lang('email_templates') ?>
                        ...
                        ?>
                            <li class="<?php
                                        if ($language == $langs->code) {
                                            echo "active";
                                        } ?>"><a href="<?= base_url('admin/settings/templates/' . $langs->code . '/') ?>" class="code"><?= lang(ucwords($langs->name)) ?></a></li>
                        <?php
                        endforeach;
                        ?>
                    </ul>
            ...
            <div class="btn-group pull-right" style="margin-bottom: 10px;">
                <button type="button" class="btn btn-xs btn-primary" title="Filter" data-toggle="dropdown"><i class="fa fa-cogs"></i> <?= lang('choose_template') ?><span class="caret"></span></button>
                <ul class="dropdown-menu animated zoomIn">
                    <li>
        ...
        <div class="panel-body">
            <div class="col-sm-12">
                <div class="btn-group">
                    ...
                    ?>
                        <a href="<?= base_url('admin/settings/templates/' . $language . '/') ?><?= $template_group; ?>/<?= $label; ?>" class="<?php
            ...
            <input type="hidden" name="return_url" value="<?= base_url('admin/settings/templates/' . $language . '/') ?><?= $template_group . '/' . $setting_email; ?>">
                ...
                <div class="available_merge_fields_container">
                    <div class="col-md-12 merge_fields_col">
                        ...
                        foreach ($email[$template_group][$setting_email] as $ltexts) { ?>
                            <span class="ml-2"><button type="button" class="add_merge_field"><?= $ltexts ?></button> </span>
                        <?php } ?>
