<div class="form-group">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            ...
            echo form_dropdown('warehouse_id', $warehouseList, $selected, array('class' => 'form-control selectpicker ' . (!empty($warehouseID) ? $warehouseID : 'mwarehouse') . '', 'onchange' => 'getItemByWarehouse(this.value)', 'data-live-search' => true, 'style' => 'width:100%'));
