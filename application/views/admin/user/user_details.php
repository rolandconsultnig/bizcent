                    ...
                    <div class="mt-lg row-table row-flush">
                        ...
                        <div class="pull-left">
                            <div class="">
                                ...
                                <small><a href="<?= base_url() ?>admin/projects/create/completed" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-lg row-table row-flush">
                        ...
                        <div class="pull-left">
                            <div class="">
                                ...
                                <small><a href="<?= base_url() ?>admin/tasks/create/completed" class="mt0 mb0"><?= lang('more_info') ?><i class="fa fa-arrow-circle-right"></i></a></small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" row-table row-flush">
                        <div class="pull-left text-white ">
                            <div class="">
                                ...
                                <small><a href="<?= base_url() ?>admin/attendance/attendance_report" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                            </div>
                        </div>
                    </div>
                    <div class="mt-lg row-table row-flush">
                        ...
                        <div class="pull-left">
                            <div class="">
                                ...
                                <small><a href="<?= base_url() ?>admin/leave_management" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                            </div>
                        </div>
                    </div>
                </div>
