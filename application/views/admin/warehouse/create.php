<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class=""><a href="<?= base_url('admin/warehouse/manage') ?>"><?= lang('manage') . ' ' . lang('warehouse') ?></a></li>
        <li class="active"><a href="<?= base_url('admin/warehouse/create') ?>"><?= lang('new') . ' ' . lang('warehouse') ?></a></li>
    </ul>
    <div class="tab-content bg-white">
        <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form" action="<?= base_url('admin/warehouse/save_warehouse/' . (!empty($warehouse_info) ? $warehouse_info->warehouse_id : '0') . '/' . $inline); ?>" method="post" class="form-horizontal  <?= (!empty($inline) ? 'myInline' : '') ?> ">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?= lang('warehouse') . ' ' . lang('code') ?> <span class="text-danger">*</span></label>
                <div class="col-lg-5">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?= lang('warehouse') . ' ' . lang('name') ?> <span class="text-danger">*</span></label>
                <div class="col-lg-5">
                    <input type="text" class="form-control" value="<?php
                                                                    if (!empty($warehouse_info)) {
