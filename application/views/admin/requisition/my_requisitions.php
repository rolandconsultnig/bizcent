...
<div class="panel panel-custom">
    <div class="panel-heading">
        <div class="panel-title">
            <strong><i class="fa fa-shopping-basket"></i> <?= lang('my_requisitions') ?></strong>
            ...
            <table class="table table-striped table-bordered" id="DataTables">
                ...
                <?php if (!empty($all_requisitions)): foreach ($all_requisitions as $v_req): ?>
                    <tr>
                        ...
                        <td>
                            <a data-toggle="modal" data-target="#myModal_lg" class="btn btn-info btn-xs" href="<?= base_url('admin/requisition/view_details/' . $v_req->requisition_id) ?>" title="View"><i class="fa fa-eye"></i></a>
                            <?php if ($v_req->status == 'pending'): ?>
                                <a class="btn btn-primary btn-xs" href="<?= base_url('admin/requisition/new_requisition/' . $v_req->requisition_id) ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-danger btn-xs" href="<?= base_url('admin/requisition/delete/' . $v_req->requisition_id) ?>" onclick="return confirm('Are you sure you want to delete this requisition?');" title="Delete"><i class="fa fa-trash"></i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
