...
if (!empty($income_expense)) { ?>
    ...
    <?php
    $donut_income = isset($income_expense['total_income']) ? (float) $income_expense['total_income'] : 0;
    $donut_expense = isset($income_expense['total_expense']) ? (float) $income_expense['total_expense'] : 0;
    if ($donut_income > 0 || $donut_expense > 0) { ?>
