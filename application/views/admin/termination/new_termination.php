...
?>
    <div class="panel panel-custom">
        ...
        <div class="modal-body wrap-modal wrap">
            <form role="form" id="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/termination/save_termination/<?= (!empty($terminations->id) ? $terminations->id : ''); ?>" method="post" class="form-horizontal form-groups-bordered">
                                ...
                                <?php foreach ($all_employee as $dept_name => $v_all_employee) : ?>
                                    <optgroup label="<?php echo $dept_name; ?>">
                                        <?php if (!empty($v_all_employee)) : foreach ($v_all_employee as $v_employee) : ?>
                                                <option value="<?php echo $v_employee->user_id; ?>" <?php echo $v_employee->user_id == $terminations->employee_id ? 'selected' : '';
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('termination_type') ?> <span class="text-danger">*</span></label>
                    <div class="col-lg-8">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?= lang('notice_date') ?> <span class="required">*</span></label>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?= lang('termination_date') ?> <span class="required">*</span></label>

                    <div class="col-sm-5">
                        <div class="input-group">
                            <input type="text" name="termination_date" required placeholder="<?= lang('enter') . ' ' . lang('notice_date') ?>" class="form-control start_date" value="<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="description" class="form-control textarea"><?= (!empty($terminations->description) ? $terminations->description : ''); ?></textarea>
                    </div>
                </div>
