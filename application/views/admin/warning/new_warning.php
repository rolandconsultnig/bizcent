...
?>
    <div class="panel panel-custom">
        ...
        <div class="modal-body wrap-modal wrap">
            <form role="form" id="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/warning/save_warning/<?= (!empty($warnings->id) ? $warnings->id : ''); ?>" method="post" class="form-horizontal form-groups-bordered">
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('warning_by') ?> <span class="text-danger">*</span></label>
                    <div class="col-lg-8">
                        <select name="warning_by" id="warning_by" class="form-control select_box" style="width: 100%" required>
                                ...
                                <?php foreach ($all_employee as $dept_name => $v_all_employee) : ?>
                                    <optgroup label="<?php echo $dept_name; ?>">
                                        <?php if (!empty($v_all_employee)) : foreach ($v_all_employee as $v_employee) : ?>
                                                <option value="<?php echo $v_employee->user_id; ?>" <?php echo $v_employee->user_id == $warnings->warning_by ? 'selected' : '';
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('warning_to') ?> <span class="text-danger">*</span></label>
                    <div class="col-lg-8">
                        <select name="warning_to" id="warning_to" class="form-control select_box" style="width: 100%" required>
                            <?php if (!empty($all_employee)) : ?>
                                <?php foreach ($all_employee as $dept_name => $v_all_employee) : ?>
                                    <optgroup label="<?php echo $dept_name; ?>">
                                        <?php if (!empty($v_all_employee)) : foreach ($v_all_employee as $v_employee) : ?>
                                                <option value="<?php echo $v_employee->user_id; ?>" <?php echo $v_employee->user_id == $warnings->warning_to ? 'selected' : '';
                                                                                                    ?>><?php echo $v_employee->fullname . ' ( ' . $v_employee->designations . ' )' ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </optgroup>
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('warning_type') ?> <span class="text-danger">*</span></label>
                    <div class="col-lg-8">
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?= lang('subject') ?> <span class="required">*</span></label>

                    <div class="col-sm-8">
                        <input type="text" required name="subject" value="<?= (!empty($warnings->subject) ? $warnings->subject : ''); ?>" class="form-control" requried="" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?= lang('warning_date') ?> <span class="required">*</span></label>

                    <div class="col-sm-5">
                        <div class="input-group">
                            <input type="text" required name="warning_date" placeholder="<?= lang('enter') . ' ' . lang('warning_date') ?>" class="form-control start_date" value="<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="description" class="form-control textarea"><?= (!empty($warnings->description) ? $warnings->description : ''); ?></textarea>
                    </div>
                </div>
