...
class Migration_Version_119 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->db->query("INSERT INTO `tbl_config` (`config_key`, `value`) VALUES ('copyright_name', 'RolandERP');");
        $this->db->query("INSERT INTO `tbl_config` (`config_key`, `value`) VALUES ('copyright_url', '#');");
